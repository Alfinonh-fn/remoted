...
class Client(object):
    ...
    def _fetchInfo(self, *ids):
		...
		# peggunaan : print _fetchInfo(100022394016980)
        data = {
    ...
    def _ping(self, sticky, pool):
        ...
        self._get(self.req_url.PING, data, fix_request=True, as_json=False, free=True)
    ...
    def _fetchSticky(self):
        ...
        j = self._get(self.req_url.STICKY, data, fix_request=True, as_json=True, free=True)
